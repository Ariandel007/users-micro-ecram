...
public interface IUserApplicationService {
    UserApplication findByUsername(String username) throws Exception;
    ...
    Page<IUserApplicationListProjection> findUserFiltered(UserListFilter userListFilter) throws Exception;
